"""
Django settings for EasyBookManagement project.
...
SECRET_KEY = "django-insecure-6v^f1d&^)x63*^de7)hsb)ei5x%+hs!l!e5mpaod%)1szo%*)9"
...
WSGI_APPLICATION = "EasyBookManagement.wsgi.application"
...
BACKUP_APPS = ["readersRecords", "booksRecords", "purchaseRecords", "operationsLog"]
